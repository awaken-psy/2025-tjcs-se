 ...
 */
export const getCapsuleMarkers = async (params = {}) => {
    try {
        // 确保提供默认的地理范围参数
        const defaultParams = {
            lat_min: 39.8,
...
// createCapsule 函数已移至 capsulesApi.js，请使用 import { createCapsule } from '@/api/new/capsulesApi.js'
