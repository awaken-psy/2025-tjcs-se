<template>
  <div class="event-create-modal" :class="{ active: show }">
...
async function handleSubmit() {
  ...
  try {
    ...
    console.log('提交创建活动数据:', submitData)
...
.suggested-tag {
  ...
  margin-bottom: 8px;
  padding: 6px 14px;
  background: rgba(26, 138, 152, 0.1);
  color: #2c7a8f;
  border-radius: 20px;
  font-size: 13px;
  font-weight: 500;
...
@media (max-width: 768px) {
  ...
  .form-body {
    padding: 20px;
    max-height: calc(95vh - 112px); /* 移动端调整高度 */
  }
