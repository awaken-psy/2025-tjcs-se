          ...
          >
            ...
            <div class="form-section">
              ...
              <div class="form-footer">
                <span class="char-count">{{ createEventData.name.length }}/50</span>
                <span
            ...
            <div class="form-section">
              ...
              />
              <div class="form-footer">
                <span class="char-count">{{ (createEventData.description || '').length }}/1000</span>
                <span
            ...
            <div class="form-section">
              <div class="section-header">
                <i class="fas fa-calendar section-icon" />
                <h3 class="section-title">
                  活动时间
                </h3>
                <span class="required-badge">必填</span>
            ...
            <div class="form-section">
              <div class="section-header">
                <i class="fas fa-clock section-icon" />
                <h3 class="section-title">
                  报名截止时间
                </h3>
                <span class="optional-badge">选填</span>
              ...
              <input
                v-model="createEventData.registerDeadline"
                type="datetime-local"
                class="form-input"
              >
            </div>
            ...
            <div class="form-section">
              ...
              <input
                v-model="createEventData.location"
                type="text"
                class="form-input"
                placeholder="请输入活动地点"
              ...
              >
              <div class="form-footer">
                <span class="char-count">{{ (createEventData.location || '').length }}/200</span>
                <span
                ...
                >
                  ...
                  >
                    ...
                    <input
                      ...
                      v-model="createEventData.cover_img"
                      type="text"
                      class="link-input"
                      placeholder="粘贴图片链接..."
            ...
            <div class="form-section">
              ...
              <div class="tags-section">
                <div class="tags-input-wrapper">
                  <input
                    v-model="createEventData.tempTagInput"
                    type="text"
                    class="tags-input"
...
const handleHeaderAction = (key) => {
  switch (key) {
    //TODO:创建活动前端已写好，等待后端同步
  case 'create': showCreateModal.value = true; break
...
const handleTagInput = (event) => {
  if (event.key === 'Enter') {
    ...
    addTag(createEventData.value.tempTagInput.trim())
  }
}
